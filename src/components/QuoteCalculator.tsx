    ...
    <div className="bg-card p-6 rounded-lg shadow-md animate-on-scroll border border-border">
      ...
      <div className="mb-6 relative flex justify-between">
        ...
        <div className={`flex items-center justify-center w-8 h-8 rounded-full text-white font-semibold z-10 ${
          step > 1 ? "bg-tectone-gold" : "bg-gray-300"
        }`}>
          2
        </div>
        <div className={`h-1 absolute top-4 left-0 right-0 z-0 ${step > 2 ? "bg-tectone-gold" : "bg-gray-300"}`}></div>
        <div className={`flex items-center justify-center w-8 h-8 rounded-full text-white font-semibold z-10 ${
          step > 2 ? "bg-tectone-gold" : "bg-gray-300"
        }`}>
          3
        </div>
      </div>
          ...
          <div className="space-y-4 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className={`border rounded-lg p-4 cursor-pointer transition-all ${
                ...
                <div className="flex flex-col items-center">
                  <div className="h-20 w-20 bg-gray-100 rounded-full flex items-center justify-center mb-3">
                    <Shield className="h-10 w-10 text-tectone-gold" />
                  </div>
              ...
              <label className={`border rounded-lg p-4 cursor-pointer transition-all ${
                ...
                <div className="flex flex-col items-center">
                  <div className="h-20 w-20 bg-gray-100 rounded-full flex items-center justify-center mb-3">
                    <Bug className="h-10 w-10 text-tectone-gold" />
                  </div>
        ...
        <DialogContent className="bg-card border-border text-foreground">
          ...
          <div className="bg-secondary/50 p-4 rounded-md mt-2">
            <p className="text-sm mb-2">
              <span className="text-tectone-gold">✓</span> Your quote has been sent successfully
            </p>
            <p className="text-sm">
              <span className="text-tectone-gold">✓</span> Please check your email for the quote details
            </p>
          </div>
